          ...
          {activeTab === 'greeting' && (
            <div>
              ...
              <textarea
                ...
                maxLength={500}
                rows={4}
                placeholder={`Hello! I'm ${currentAgent?.name || 'the agent'}. How can I help you today?`}
                className="w-full px-4 py-3 text-white outline-none resize-none"
                style={{
                  backgroundColor: 'rgba(26, 26, 46, 0.6)',
                  border: '1px solid rgba(255,255,255,0.2)',
      ...
      <div className="mt-6 flex items-center gap-3">
        ...
        <button
          onClick={() => {
            ...
            if (defaultConfig) {
              updateConfig({
                systemPrompt: `You are ${currentAgent?.name || 'the agent'}.`,
                welcomeMessages: [],
      ...
      <AnimatePresence>
        {savedToast && (
          ...
          >
            ...
            >
              Prompts updated for {currentAgent?.name}
            </span>
          </motion.div>
        )}
      </AnimatePresence>
